...
public final class Constants {
  ...
  public static final class Swerve {
    ...
    public static final class Mod0 {
      ...
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(225.564);
    ...
    public static final class Mod1 {
      ...
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(170.768);
    ...
    public static final class Mod3 {
      ...
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(20.344);
      // public static final SwerveModuleConstants2 constants =
      //     new SwerveModuleConstants2(driveMotorID, angleMotorID, canCoderID, angleOffset);
    }
    ...
    public static final class Mod2 {
      ...
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(219.049);
      // public static final SwerveModuleConstants2 constants =
      //     new SwerveModuleConstants2(driveMotorID, angleMotorID, canCoderID, angleOffset);
    }
  }
  ...
  public static final class ArmSubsystem {
    ...
    public static final double armPosFarSpeaker = 20;
    public static final double armYeetIt = 35;
