...
public final class Constants {
  ...
  public static final class Swerve {
    ...
    public static final double angleKP = 0.1; // chosenModule.angleKP;
    public static final double angleKI = 0; // chosenModule.angleKI;
    public static final double angleKD = 00; // chosenModule.angleKD;
    public static final double angleKF = 00; // chosenModule.angleKF;
