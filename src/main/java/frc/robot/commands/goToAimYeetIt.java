...
public class goToAimYeetIt extends SequentialCommandGroup {
  ...
  public goToAimYeetIt(Arm arm, Slider slider) {
    ...
    if (startAngle <= 10) {
      addCommands(
          ...
          new ArmSliderGoToPosition(
              ...
              .alongWith( // intake Extend's arm in
                  new ArmRotateGoToPosition(
                          Constants.ArmSubsystem.armYeetIt,
      ...
      addCommands(
          new ArmRotateGoToPosition(
                  Constants.ArmSubsystem.armYeetIt, Constants.ArmSubsystem.goalTolerance, arm)
              .withTimeout(1)
