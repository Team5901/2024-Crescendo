...
public class SmartIntakeIn extends Command {
  private Arm arm;
  private Slider slider;
  private boolean a,b;
  /** Creates a new IntakeOutStateMachine. */
  public SmartIntakeIn(Arm arm, Slider slider) {
    this.arm = arm;
    this.slider = slider;
  ...
  public boolean isFinished() {
    ...
    b=Math.abs(arm.getAngle() - Constants.ArmSubsystem.armPosIn ) <Constants.ArmSubsystem.goalTolerance;
    return  a && b;
  }
}
